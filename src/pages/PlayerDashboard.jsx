...
export default function PlayerDashboard({ playerCode }) {
  ...
  if (!player) return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="text-center">
        ...
        <a href="/" className="bg-yellow-400 text-slate-900 font-bold px-6 py-3 rounded-xl">← Back to App</a>
      </div>
    </div>
  )
    ...
    <div className="min-h-screen bg-slate-900 text-white pb-10">
      ...
      <div className="bg-slate-900 border-b border-slate-800 sticky top-0 z-10">
        <div className="max-w-lg mx-auto px-4 py-4 flex items-center gap-3">
          <a href="/" className="text-slate-400 hover:text-white text-2xl transition-colors">←</a>
          <div>
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-4">
        ...
        <div className="bg-gradient-to-br from-slate-800 to-slate-800/50 rounded-2xl p-6 border border-slate-700">
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="text-right">
              ...
              <div className="text-slate-400 text-xs mt-1">Rank #{rank}</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 mb-4">
            {[
              ...
              { label: 'Streak', value: player.streak||0, color: 'text-orange-400' },
              { label: 'Best Streak', value: player.highestStreak||player.streak||0, color: 'text-purple-400' },
            ].map(stat => (
        ...
        <button onClick={shareProfile}
          className="w-full bg-green-600/20 hover:bg-green-600/30 border border-green-500/40 text-green-400 font-bold py-4 rounded-xl transition-colors flex items-center justify-center gap-2 text-lg">
